...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/api/fileupload/baidu"             //图片上传提交地址
       //,imagePath:URL + "jsp/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        , toolbars: [["source", "selectall", "|", "undo", "redo", "searchreplace", "|", "bold", "italic", "underline", "strikethrough", "forecolor", "backcolor", "|", "removeformat", "formatmatch", "pasteplain", "autotypeset", "|", "insertunorderedlist", "insertorderedlist", "unlink", "link", "|", "justifyleft", "justifycenter", "justifyright", "justifyjustify", "fullscreen"],
         ["fontfamily", "fontsize", "|", "imagenone", "imageleft", "imagecenter", "imageright", "|", "insertimage", "map", "pagebreak", "anchor", "horizontal", "|", "inserttable", "mergecells", "insertcol", "insertrow", "deletecol", "deleterow", "|", "preview", "help"], []]
