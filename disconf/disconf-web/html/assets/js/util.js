...
/**
 * 将14位时间格式转化为日期字符串
 * @param {string} dateNum 日期字符串.
 * @param {string=} opt_formatType 日期字符串的格式，默认是yyyy-M-d HH:mm:ss.
 * @return {string}
 */
...
/*
 * Tangram
 * Copyright 2009 Util Inc. All rights reserved.
 * 
 * path: Util/cookie/get.js
 * author: erik
 * version: 1.1.0
 * date: 2009/11/15
 */
...
/*
 * 获取location中search的值
 * @return {string} value 返回activityId
 */
...
/*
 * 获取location中path的值
 * @return {string} value 返回pageName
 */
...
/*
 * 获取location中search的值
 * @return {string} value 返回创建页面时的序号
 */
