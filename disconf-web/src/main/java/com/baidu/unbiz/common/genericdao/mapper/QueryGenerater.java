...
public class QueryGenerater <ENTITY extends BaseObject<KEY>, KEY extends Serializable>{
	...
	public QueryGenerater(ORMapping<ENTITY, KEY> orMapping,
			GenericDao<KEY, ENTITY> genericDao) {
	...
	public Query getPageQuery(int curPage,
			int pageSize, Collection<Match> matches, Order...orders){
	 ...
	 * @param matches
	 * @return
	 * 下午1:14:54 created by Darwin(Tianxin)
	 */
	 ...
	 * @param matches
	 * @return
	 * 下午3:15:10 created by Darwin(Tianxin)
	 */
	 ...
	 * @param sb
	 * @param params
	 * 上午10:09:44 created by Darwin(Tianxin)
	 */
	private void appendModifytoSQL(List<Modify> modifies, StringBuilder sb,
			List<Object> params) {
	 ...
	 * @param entities
	 * @return
	 * 下午1:26:37 created by Darwin(Tianxin)
	 */
	...
	public Query getCreateQuery(boolean generateKey, boolean quick,InsertOption option, ENTITY...entities){
		return getCreateQuery(Arrays.asList(entities), generateKey, quick,
				option);
	}
	...
	public Query getCreateQuery(List<ENTITY> entities, boolean generateKey, boolean quick,InsertOption option){
		...
		//bug fixed
		sb.append("insert " + ((option != null) ? option : "") + " into ")
				.append(dao.getTableName()).append(" (");
	 ...
	 * @param entity
	 * @return
	 * 上午9:51:49 created by Darwin(Tianxin)
	 */
	 ...
	 * @param id
	 * @return
	 * 上午9:45:33 created by Darwin(Tianxin)
	 */
	 ...
	 * @param params
	 */
	public void appendQuerytoSQL(Collection<Match> matches, StringBuilder sb,
			List<Object> params) {
