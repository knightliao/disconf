...
public abstract class GenericDao<KEY extends Serializable, ENTITY extends BaseObject<KEY>> implements
	 ...
	 * @param ids
	 * @return
	 * 下午9:03:31 created by Darwin(Tianxin)
	 */
	 ...
	 * @param matches
	 * @return
	 * 2013-8-26 下午3:04:02 created by wangchongjie
	 */
	 ...
	 * @return
	 */
	public List<ENTITY> find(List<Match> matches, List<Order> order, int offset,
                    int limit) {
		//FIXME
		Query operate = queryGenerater
				.getSelectQuery(
						matches,
						(order == null) ? null : order.toArray(new Order[order
								.size()]));
	 ...
	 * @return
	 */
	public List<ENTITY> page(List<Match> matches, List<Order> order, int curPage,
			int pageSize) {
	 ...
	 * @param ids
	 * @return
	 * 下午8:54:16 created by Darwin(Tianxin)
	 */
	 ...
	 * @param params
	 * @return
	 * 下午1:11:38 created by Darwin(Tianxin)
	 */
	@SuppressWarnings("unchecked")
	private ENTITY createAndFetchKey(ENTITY entity, final String sql,
	...
	/**
	 * @return
	 * 下午5:39:05 created by Darwin(Tianxin)
	 */
...
//        boolean autoGenerateKey = key == null;
        ...
        // 获取insert语句
		Query query = queryGenerater.getCreateQuery(entities, key == null,
				false, option);
