...
public class GenericMapper<ENTITY extends BaseObject<K>, K extends Serializable> implements RowMapper<ENTITY> {
	 ...
	 * @param value
	 * @throws Exception
	 * 下午4:06:04 created by Darwin(Tianxin)
	 */
	private void load2Entity(Object entity, Method setMethod, Object value)
			throws Exception {
		try {
			if (value != null) {
			...
			System.out.println("Error in " + setMethod.getName() + " invoke with param :" + sValue + " type is " + sValueClass);
			throw e;
		}
	}
	 ...
	 * @return
	 * 下午3:45:38 created by Darwin(Tianxin)
	 * @throws SQLException 
	 */
